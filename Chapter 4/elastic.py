...
elasticServer = os.environ.get('ES_METRICS_CLUSTER_URL', 'http://192.168.43.226:9200')
...
elasticMonitoringCluster = os.environ.get('ES_METRICS_MONITORING_CLUSTER_URL', 'http://192.168.43.226:9200')
